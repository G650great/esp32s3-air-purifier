...
基于 ESP32-S3 的智能空气净化器控制系统，支持环境监测、智能控制、远程监控和本地显示。

## 功能特性

- **环境监测**：实时监测温度、湿度、空气质量
- **智能控制**：支持手动/自动两种风扇控制模式
- **远程控制**：通过 WiFi 和 MQTT 协议实现远程监控和控制
